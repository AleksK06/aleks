...
<header>
    ...
    <main role="main" class="container">
      <h1 class="mt-5">Определить, можно ли сделать две квадратных заготовки со стороной А из листа железа прямоугольной формы со сторонами В и С.</h1>
		<form method="POST">
			...
			<div>
				<label for="exampleInputC">Введите значение C</label>
				<input type="number" class="form-control" name="C" id="exampleInputC" placeholder="Значение C">
			</div>
			<p></p>
			<div>
